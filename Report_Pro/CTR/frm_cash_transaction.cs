    ...
    public partial class frm_cash_transaction : Form
    {
        ...
        private void btn_cash_recet_Click(object sender, EventArgs e)
        {
            ...
            dt1 = dal.getDataTabl_1(@"SELECT D.ACC_NO,P.Payer_name,D.BRANCH_code,
                    ...
                    inner join wh_BRANCHES As B on D.BRANCH_code = B.BRANCH_code
                    where D.BRANCH_code = '" + Branch.ID.Text + "' and  d.acc_no like '123%' and  convert(varchar,D.g_date,111)  between '" +
        ...
        private void btn_bank_recet_Click(object sender, EventArgs e)
        {
            ...
            dt1 = dal.getDataTabl_1(@"SELECT D.ACC_NO,P.Payer_name,D.BRANCH_code,
                    ...
                    where D.BRANCH_code = '" + Branch.ID.Text + "' and   d.acc_no like '123%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "' and Sanad_type2 = 'BR'");
            ds.Tables.Add(dt1);
            ds.WriteXmlSchema("schema_xml");
            rpt.SetDataSource(ds);
            rpt.DataDefinition.FormulaFields["From_date"].Text = "'" + FromDate.Value.ToString("yyyy/MM/dd") + "'";
        ...
        private void btn_bank_deposit_Click(object sender, EventArgs e)
        {
            ...
            dt1 = dal.getDataTabl_1(@"SELECT D.ACC_NO,P.Payer_name,D.BRANCH_code,
                    ...
                    inner join payer2 As P on D.Acc_no = P.acc_no and D.BRANCH_code=p.BRANCH_code
                    join wh_BRANCHES As B on D.BRANCH_code = B.BRANCH_code
                    where  D.BRANCH_code = '" + Branch.ID.Text + "'  and  d.acc_no like '122%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "' and Sanad_type2 = 'CB'");
            ds.Tables.Add(dt1);
            ds.WriteXmlSchema("schema_xml");
            rpt.SetDataSource(ds);
            rpt.DataDefinition.FormulaFields["From_date"].Text = "'" + FromDate.Value.ToString("yyyy/MM/dd") + "'";
        ...
        private void btn_fees_Click(object sender, EventArgs e)
        {
            ...
            dt1 = dal.getDataTabl_1(@"SELECT D.ACC_NO,P.Payer_name,D.BRANCH_code,
                    ...
                    inner join payer2 As P on D.Acc_no = P.acc_no and D.BRANCH_code=p.BRANCH_code
                    join wh_BRANCHES As B on D.BRANCH_code = B.BRANCH_code          
            where  D.BRANCH_code = '" + Branch.ID.Text + "' and  d.acc_no like '32%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "' and Sanad_type2 = 'CE'");
            ds.Tables.Add(dt1);
            ds.WriteXmlSchema("schema_xml");
            rpt.SetDataSource(ds);
            rpt.DataDefinition.FormulaFields["From_date"].Text = "'" + FromDate.Value.ToString("yyyy/MM/dd") + "'";
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tabControl1.SelectedTab = tabItem1;
                dt_tr = dal.getDataTabl_1(@"SELECT  branch_name, SUM(CASE WHEN  d.acc_no like '121%' and convert(varchar,D.g_date,111) > '1950-01-01' and convert(varchar,D.g_date,111) < '" + FromDate.Value.ToString("yyyy/MM/dd") + "'  THEN meno -loh ELSE 0 END) AS Begining_balance " +
                ...
                ", SUM(CASE WHEN d.acc_no like '121%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "' and Sanad_type2 = 'CB'  THEN loh ELSE 0 END) AS bank_deposit " +
                ...
                ", SUM(CASE WHEN d.acc_no like '121%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "'  and SOURCE_CODE like 'Xp%' THEN meno - loh ELSE 0 END) AS purchase_ " +
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt_tr = new DataTable();
            tabControl1.SelectedTab = tabItem1;
            dt_tr = dal.getDataTabl_1(@"SELECT  branch_name, SUM(CASE WHEN  d.acc_no like '121%' and convert(varchar,D.g_date,111) > '1950-01-01' and cast(D.g_date as date) < '" + FromDate.Value.ToString("yyyy/MM/dd") + "'  THEN meno -loh ELSE 0 END) AS Begining_balance " +
            ", SUM(CASE WHEN d.acc_no like '121%' and convert(varchar,D.g_date,111) between '" + FromDate.Value.ToString("yyyy/MM/dd") + "' and '" + ToDate.Value.ToString("yyyy/MM/dd") + "'  and SOURCE_CODE like 'XS%' THEN meno - loh ELSE 0 END) AS sales_ " +
            ...
            "FROM daily_transaction as D inner join payer2 As P on D.Acc_no = P.acc_no and D.BRANCH_code = p.BRANCH_code " +
            "inner join wh_BRANCHES As B on D.BRANCH_code = B.BRANCH_code where B.notes='مبيعات' and  B.BRANCH_code like '" + Branch.ID.Text + "%' group by branch_name  ");
