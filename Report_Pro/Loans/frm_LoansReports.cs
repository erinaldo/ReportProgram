...
namespace Report_Pro.Loans
{
    public partial class frm_LoansReports : Form
    {
        ...
        private void btnReportToal_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = dal.getDataTabl_1(@"select A.BankId,C.PAYER_NAME,C.payer_l_name,A.LoanNo,A.StartDate,A.LoanValue,
            ...
            "group by A.BankId,C.PAYER_NAME,C.payer_l_name,A.LoanNo,A.StartDate,A.LoanValue");
        ...
        {
            DataTable dt = dal.getDataTabl_1(@"select  A.BankId,C.PAYER_NAME,C.payer_l_name,A.LoanNo,A.StartDate,A.MaturityDate,A.PaymentNo,A.PaymentValue,
          ...
          "group by A.BankId,C.PAYER_NAME,C.payer_l_name,A.LoanNo,A.StartDate,A.MaturityDate,A.PaymentNo,A.PaymentValue");
            DataSet ds = new DataSet();
            ds.Tables.Add(dt);
            ds.WriteXmlSchema("schema_rpt.xml");
