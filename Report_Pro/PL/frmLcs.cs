...
namespace Report_Pro.PL
{
    public partial class frmLcs : Form
    {
        ...
        private void buttonX2_Click_1(object sender, EventArgs e)
        {
            ...
            //(form.Fields["lc_expiry"] as PdfLoadedTextBoxField).Text = OpenDate.Value.Date.ToString("dd/MM/yyyy");
        ...
        private void btnPrintForm_Click(object sender, EventArgs e)
        {
            ...
            //(form.Fields["Partial shipment allowed"] as PdfLoadedCheckBoxField).Checked = true;
            //(form.Fields["Amount"] as PdfLoadedTextBoxField).Text = Amount.Text;
            //(form.Fields["c"] as PdfLoadedTextBoxField).Text = ExpiryDate.Value.Date.ToString("DD/MM/YYYY");
