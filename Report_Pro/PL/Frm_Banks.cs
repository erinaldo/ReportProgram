    ...
    public partial class Frm_Banks : Form
    {
        ...
        private void BSearch_Click(object sender, EventArgs e)
        {
            ...
            frmSrchBank.ShowDialog();
                ...
                BID.Enabled = false;
                BSave.Text = "تعديل";
               //showData(frmSrchBank.DGV1.CurrentRow.Cells[0].Value.ToString());

            var db = new DAL.dbDataContext();
            bnk = db.BanksTbls.Where(b => b.BID == Convert.ToInt32(frmSrchBank.DGV1.CurrentRow.Cells[0].Value)).First();
            GetData();
            //DataTable Bdt= getBankData(frmSrchBank.DGV1.CurrentRow.Cells[0].Value.ToString());
        ...
        private void BAccept_TextChanged(object sender, EventArgs e)
        {

        }

        private void Loans_Rate_TextChanged(object sender, EventArgs e)
        {
